...
**🆕 RPG + Roguelike 模式**：选一个炮台当你的队伍(其余 3 队 AI)。**逐波清敌**——打光 3 个 AI 即清一波,敌人随即满血复活并逐波变强,连续挑战 **8 波**通关;每次击杀触发**三选一强化**(装甲/钢珠/护盾/宣示主权/本体充能/核武……,波次越高选项越强);弹雨/地动/祝福/磁暴/寒霜随机事件让每局不同(触发时战场中央浮现事件水印)。整局通关拿金币与经验,在**局外商店**买遗物(钢珠/涡轮/装甲/第二生命……,**只对你生效**、跨局永久、可叠加)——越玩越强。
...
- **左上弹珠面板（Plinko）** —— 四色小球循环下落，落入 **RELEASE**（增加本体值弹药后全部发射）/ **MULTIPLY**（弹药 ×(1+本体值)）/ **SPIN**（进技能转盘）。
- **右侧技能转盘** —— 普通转盘 9 个技能，金色 ★ 扇区掉入下方**终极转盘** 8 个大招。
- **本体值系统** —— 每颗面板球有「本体值」（显示在球身上，吃终极「本体+1」可增长）。本体值越高，该球进入转盘触发的技能效果越强（**N 倍**：加量、护盾时长、倍率、投射物威力等全部按本体值放大）。
